<template>
  <div class="postResort">
    <h2>create a new resort</h2>
    <form @submit.prevent="upload">
      ...
      <div class="btn">
        <button
          :class="['button', resortsMd.canPost ? '' : 'cantPost']"
          v-html="resortsMd.postButton"
          style="float: right"
        ></button>
      </div>
    </form>
...
const resortsMd = store.state.resortsModule
const location = ref('')
const name = ref('')
const desc = ref('')
